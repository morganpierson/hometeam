...
import internalJobMatch from '@/app/images/screenshots/internal_job_match.png'
import employeeProfile from '@/app/images/screenshots/employee_profile.png'
import employeeProfileAgency from '@/app/images/screenshots/employee_profile_agency.png'
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'w-9 rounded-lg',
          isActive ? 'bg-amber-500' : 'bg-slate-500',
        )}
      >
