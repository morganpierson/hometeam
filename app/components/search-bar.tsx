    ...
    <div className="sticky top-0">
      <div className="relative rounded-md shadow-sm border border-gray-200 bg-white mb-12 p-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="bg-white h-14 rounded-md px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
            <label
